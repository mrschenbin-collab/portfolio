      ...
      {projects.map((project, index) => (
        ...
        >
          <div className="project-card-image">
            {project.images[0] ? <img src={project.images[0].url} alt={project.images[0].altText} /> : <div className={`art-surface ${project.tone}`}><span className="serif">{String(index + 1).padStart(2, "0")}</span><strong>{project.title}</strong></div>}
          </div>
